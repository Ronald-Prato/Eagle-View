...
var data = [{
  Kudu_master: "terms",
  Principal_Hive_Metastore: "category",
  URI_Hive_Metastore: "login",
  URI_Hue: "privacy",
  URI_Jobtracker: "author",
  URI_Namenode: "search",
  URI_Oozie: "register",
  Zona_de_Staging: "login",
  Zona_de_landing: "privacy",
  Zona_de_logs: "author",
  Zona_de_workflows: "privacy",
  Zona_landing_tmp: "category",
  key: "1"
}, {
  Kudu_master: "terms",
  Principal_Hive_Metastore: "category",
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_1___default()(Data).map(function (x) {
              columns.push({
                title: x,
...
//# sourceMappingURL=index.js.ab538fa9676501966790.hot-update.js.map