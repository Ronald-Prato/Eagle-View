    ...
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            _context.next = 5;
            return _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_2___default()(state.data[state.option_to_load]).map(function (key) {
              _babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_1___default()(state.data[state.option_to_load]).map(function (value) {
                data[key] = value;
              });
            });
...
//# sourceMappingURL=index.js.c113580b1bac8c9b7a33.hot-update.js.map