...
var SlideOptions = function SlideOptions() {
  ...
  var createTable = function createTable(param) {
    return function () {
      console.log(typeof _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_3___default()(param) + "  " + typeof options[0]);
      _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_3___default()(param).toString() === options[0] ? actions({
        type: 'set-new-state',
...
//# sourceMappingURL=index.js.72a881ade777b931a99a.hot-update.js.map